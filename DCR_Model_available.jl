...
# Events make the system solve, but it will take much much longer. Leave this false if you can. 
...
if events == false
    ...
    sol = solve(prob, IDA(linear_solver  = :LapackDense), maxiters = 10^9, callback=combined_cb,  dtmax = 1e-4, reltol = 1e-7, abstol = 1e-7, progress=true, progress_steps=1)
end
